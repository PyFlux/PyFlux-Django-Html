...
class Country(models.Model, BaseDatatableView):
    class Meta:
    ...
    listable = {'Country Name': '', 'Status': ''}
    columns = ['id', 'country_name', 'status']
    order_columns = ['id', 'created_by', 'updated_by', 'created_at', 'updated_at', 'deleted_at']
    max_display_length = 500
    max_display_length = 500
    class_view_name = 'GetAjaxViewCountry'

    table_name = "system_config_country"

    model_name = "Country"
    acl_key = "pyflux.admin.Country"

    parameter_array = {'acl_key': 'dashboard.admin.country'}
    ...
    routes = {"add_route": "addcountry", "edit_route": "editcountry", "view_route": "viewcountry"}

    advanced_filter = {"layout": "country/advancedfilter/countryformfilter.html",
                       'filters':
                           {
...
class GetAjaxViewCountry(BaseDatatableView):
    ...
    def render_column(self, row, column):
        if column == 'id':
            ...
            return super(GetAjaxViewCountry, self).render_column(row, column)
