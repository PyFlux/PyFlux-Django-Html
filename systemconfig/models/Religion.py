...
class Religion(models.Model, BaseDatatableView):
    class Meta:
    ...
    page_title = 'Manage Religion'
    listable = {'Religion': '', 'Status': ''}
    columns = ['id', 'student_religion', 'status']
    order_columns = ['id', 'created_by', 'updated_by', 'created_at', 'updated_at', 'deleted_at']
    max_display_length = 500
    max_display_length = 500
    class_view_name = 'GetAjaxViewReligion'

    table_name = "system_config_religion"

    model_name = "Religion"
    acl_key = "pyflux.admin.Religion"

    parameter_array = {'acl_key': 'dashboard.admin.religion'}
    ...
    routes = {"add_route": "addreligion", "edit_route": "editreligion", "view_route": "viewreligion"}

    advanced_filter = {"layout": "religion/advancedfilters/religionfilter.html",
                       'filters':
                           {
...
class GetAjaxViewReligion(BaseDatatableView):
    ...
    def render_column(self, row, column):
        if column == 'id':
            ...
            return super(GetAjaxViewReligion, self).render_column(row, column)
