...
class CityTown(models.Model, BaseDatatableView):
    class Meta:
    ...
    city_state_id = models.CharField(max_length=255)
    city_country_id = models.CharField(max_length=255)
    ...
    listable = {'City': '', 'State': '', 'Country': '', 'Status': ''}
    columns = ['id', 'city_name', 'city_state_id', 'city_country_id', 'status']
    order_columns = ['id', 'created_by', 'updated_by', 'created_at', 'updated_at', 'deleted_at']
    max_display_length = 500
    max_display_length = 500
    class_view_name = 'GetAjaxViewCityTown'

    table_name = "system_config_citytown"

    model_name = "CityTown"
    acl_key = "pyflux.admin.CityTown"

    parameter_array = {'acl_key': 'dashboard.admin.citytown'}
    ...
    routes = {"add_route": "addcity", "edit_route": "editcity", "view_route": "viewcity"}

    advanced_filter = {"layout": "city/advancedfilter/cityformfilter.html",
                       'filters':
                           {
...
class GetAjaxViewCityTown(BaseDatatableView):
    ...
    def render_column(self, row, column):
        if column == 'id':
            ...
            return super(GetAjaxViewCityTown, self).render_column(row, column)
