...
class Nationality(models.Model, BaseDatatableView):
    class Meta:
    ...
    nationality_name = models.CharField(max_length=255)
    ...
    page_title = 'Manage Nationality'
    listable = {'Nationality': '', 'Status': ''}
    columns = ['id', 'nationality_name', 'status']
    order_columns = ['id', 'created_by', 'updated_by', 'created_at', 'updated_at', 'deleted_at']
    max_display_length = 500
    max_display_length = 500
    class_view_name = 'GetAjaxViewNationality'

    table_name = "system_config_nationality"

    model_name = "Nationality"
    acl_key = "pyflux.admin.Nationality"

    parameter_array = {'acl_key': 'dashboard.admin.nationality'}
    ...
    routes = {"add_route": "addnationality", "edit_route": "editnationality", "view_route": "viewnationality"}

    advanced_filter = {"layout": "nationality/advancedfilter/nationalityformfilter.html",
                       'filters':
                           {
...
class GetAjaxViewNationality(BaseDatatableView):
    ...
    def render_column(self, row, column):
        if column == 'id':
            ...
            return super(GetAjaxViewNationality, self).render_column(row, column)
