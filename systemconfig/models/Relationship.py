...
class Relationship(models.Model, BaseDatatableView):
    class Meta:
    ...
    page_title = 'Manage Relationship'
    listable = {'name': '', 'Status': ''}
    columns = ['id', 'name', 'status']
    order_columns = ['id', 'created_by', 'updated_by', 'created_at', 'updated_at', 'deleted_at']
    max_display_length = 500
    max_display_length = 500
    class_view_name = 'GetAjaxViewRelationship'

    table_name = "system_config_relationship"

    model_name = "Relationship"
    acl_key = "pyflux.admin.Relationship"

    parameter_array = {'acl_key': 'dashboard.admin.relationship'}
    ...
    routes = {"add_route": "addrelationship", "edit_route": "editrelationship", "view_route": "viewrelationship"}

    advanced_filter = {"layout": "relationship/advancedfilters/relationshipfilter.html",
                       'filters':
                           {
...
class GetAjaxViewRelationship(BaseDatatableView):
    ...
    def render_column(self, row, column):
        if column == 'id':
            ...
            return super(GetAjaxViewRelationship, self).render_column(row, column)
