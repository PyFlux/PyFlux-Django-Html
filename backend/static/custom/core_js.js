...
function findRoute(route_name) {
    ...
    if (route_name == 'add') {
        ...
        if (sel_length <= 0) {
            ...
            Command: toastr["error"]("Please select any record!")

            return false;
        }
        if (sel_length > 1) {
            // alert('You cannot modify more than 1 record at a time!');
            Command: toastr["error"]("You cannot modify more than 1 record at a time!")
...
function findAction(action_name) {
    ...
    if (sel_length <= 0) {
        ...
        Command: toastr["info"]("Please select at least one record to perform an action!")
        return false;
    }
